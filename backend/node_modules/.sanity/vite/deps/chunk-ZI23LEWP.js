...
import {
  ...
  visitDiff,
  white
} from "./chunk-XY7NRVKT.js";
import {
  require_image_url_umd
} from "./chunk-YJ3LOHID.js";
import {
  EMPTY,
  Subject,
  asyncScheduler,
...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: commentsLocaleNamespace, resources: () => import("./resources-BxKucOVx-MSNOWHMF.js") });
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: structureLocaleNamespace, resources: () => import("./resources-B_y3iqGc-HHGUQSQW.js") });
...
var structureTool = definePlugin((options) => {
  ...
  return { name: "sanity/structure", document: { actions: (prevActions) => {
    ...
    icon,
    component: (0, import_react3.lazy)(() => import("./index-BV_8ds5h-SA7QOZNM.js")),
...
//# sourceMappingURL=chunk-ZI23LEWP.js.map
